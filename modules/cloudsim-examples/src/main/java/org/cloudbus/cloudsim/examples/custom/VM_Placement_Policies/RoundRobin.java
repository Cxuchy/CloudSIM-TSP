...
import org.cloudbus.cloudsim.examples.custom.VM_Placement_Policies.Policies.VmAllocationPolicyRoundRobin;
...
public class RoundRobin {
    ...
    // Snapshot captured during allocation
    ...
    public static void main(String[] args) {
        try {
            ...
            // Use RoundRobin policy — intercept snapshot on each allocation
            VmAllocationPolicyRoundRobin policy = new VmAllocationPolicyRoundRobin(hostList) {
                @Override
            ...
            PowerDatacenter datacenter = createDatacenter("DC_RoundRobin", hostList, policy);
    ...
    private static void printResults(PowerDatacenter datacenter) {
        ...
        System.out.println("\n╔══════════════════════════════════════════════════════╗");
        System.out.println("║       RÉSULTATS — POLITIQUE ROUND ROBIN             ║");
        System.out.println("╚══════════════════════════════════════════════════════╝");
    ...
    private static void displayChart(List<String> xData, List<Number> yData) {
        CategoryChart chart = new CategoryChartBuilder()
                ...
                .title("RoundRobin — VMs par hôte  (capacité: 3000 MIPS/hôte)")
