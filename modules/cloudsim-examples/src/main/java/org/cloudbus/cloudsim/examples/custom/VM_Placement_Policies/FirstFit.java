...
public class FirstFit {
    ...
    public static void main(String[] args) {
        try {
            ...
            PowerDatacenter datacenter = createDatacenter("DC_FirstFit", hostList, policy);
            DatacenterBroker broker    = new DatacenterBroker("Broker_FirstFit");
    ...
    private static void printResults(PowerDatacenter datacenter) {
        ...
        System.out.println("\n╔══════════════════════════════════════════════════════╗");
        System.out.println("║       RÉSULTATS — POLITIQUE FIRST FIT               ║");
        System.out.println("╚══════════════════════════════════════════════════════╝");
    ...
    private static void displayChart(List<String> xData, List<Number> yData) {
        CategoryChart chart = new CategoryChartBuilder()
                ...
                .title("FirstFit — VMs par hôte  (capacité: 3000 MIPS/hôte)")
