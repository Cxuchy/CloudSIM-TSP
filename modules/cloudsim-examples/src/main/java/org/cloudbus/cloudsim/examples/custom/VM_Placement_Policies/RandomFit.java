...
import org.cloudbus.cloudsim.examples.custom.VM_Placement_Policies.Policies.VmAllocationPolicyRandomFit;
...
public class RandomFit {
    ...
    public static void main(String[] args) {
        try {
            ...
            PowerDatacenter datacenter = createDatacenter("DC_RandomFit", hostList, policy);
            DatacenterBroker broker    = new DatacenterBroker("Broker_RandomFit");
    ...
    private static void printResults(PowerDatacenter datacenter) {
        ...
        System.out.println("\n╔══════════════════════════════════════════════════════╗");
        System.out.println("║       RÉSULTATS — POLITIQUE RANDOM FIT              ║");
        System.out.println("╚══════════════════════════════════════════════════════╝");
    ...
    private static void displayChart(List<String> xData, List<Number> yData) {
        CategoryChart chart = new CategoryChartBuilder()
                ...
                .title("RandomFit — VMs par hôte  (capacité: 3000 MIPS/hôte)")
